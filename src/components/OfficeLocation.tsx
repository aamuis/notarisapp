...
export const OfficeLocation: React.FC<OfficeLocationProps> = ({ lang }) => {
  const gmapsSearchUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(
    'Taman Banten Lestari, Blok F20 No.07, Unyur, Kota Serang, Banten 42111'
  )}`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="space-y-5">
              ...
              <div className="border-b border-slate-200 pb-4">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed flex items-start gap-2.5">
                  ...
                  <span>{NOTARY_PROFILE.address.full}</span>
                </p>
              </div>
              ...
              <div className="space-y-2 text-xs text-slate-700">
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 flex justify-between items-center">
                  ...
                  <span className="font-bold text-slate-900">08.30 – 17.00 WIB</span>
                </div>
                
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 flex justify-between items-center">
                  <span className="text-slate-600 font-medium">{lang === 'id' ? 'Sabtu' : 'Saturday'}</span>
                  <span className="font-bold text-amber-800">09.00 – 14.00 WIB (Janji Temu)</span>
                </div>
                
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 flex justify-between items-center">
                  <span className="text-slate-600 font-medium">{lang === 'id' ? 'Minggu & Hari Libur' : 'Sunday & Holidays'}</span>
                  <span className="text-rose-600 font-bold">Tutup (Online WA Standby)</span>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-2 text-xs">
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="font-bold text-slate-900">{NOTARY_PROFILE.whatsappFormatted}</span>
                  </div>
                </a>

                <a
                  href={`https://wa.me/${NOTARY_PROFILE.whatsapp}?text=Halo%20Notaris%20Syarifah%20Nurul%20Aziizi,%20saya%20ingin%20berkonsultasi.`}
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="font-extrabold text-emerald-900">{NOTARY_PROFILE.whatsappFormatted}</span>
                  </div>
                </a>
              </div>
          ...
          <div className="lg:col-span-7 bg-white p-2.5 sm:p-3 rounded-3xl border border-slate-200 shadow-lg flex flex-col min-h-[380px] overflow-hidden">
            <div className="w-full h-full min-h-[360px] rounded-2xl overflow-hidden relative border border-slate-200">
              <iframe
                title="Peta Lokasi Kantor Notaris Syarifah Nurul Aziizi Kota Serang"
